...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('davemode', ClientPrefs.data.davemode);
		set('sicon', ClientPrefs.data.sicon);
		set('ohiotwn', ClientPrefs.data.ohiotwn);
		set('realityindic', ClientPrefs.data.realityindic);

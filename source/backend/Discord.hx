...
class DiscordClient
{
	...
	private static final _defaultID:String = "1192302740207046697";
	...
	public static function changePresence(?details:String = 'main menu stufff', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageKey = 'se_logo';
